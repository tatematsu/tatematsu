...
sub form_mailbody_top {
	...
	if( $n eq 'ra' ){
		...
		$sub_radio = qq|<tr><td bgcolor="#FFFFCC">利用</td><td><input type="radio" name="a_conf" value="1"$checked1>する<input type="radio" name="a_conf" value="0"$checked0>しない</td></tr><tr><td colspan="2">&nbsp;</td></tr>|;
		$sub_message = <<"END";
...
END
	...
	# 解除時別設定
	if( $n eq 'c' ){
		$sub_link_r = qq|<a href="$main'indexcgi?md=ml&n=ca&id=$id"><font color="#0000FF">&gt;&gt;【管理者通知専用】本文設定へ</font></a><br>&nbsp;|;
	}
	if( $n eq 'ca' ){
		$sub_link_r = qq|<a href="$main'indexcgi?md=ml&n=c&id=$id"><font color="#0000FF">&gt;&gt;通常の【解除時】本文設定へ</font></a><br>&nbsp;|;
		my $checked0 = ( $config )? '': ' checked="checked"';
		my $checked1 = ( $config )? ' checked="checked"': '';
		$sub_radio = qq|<tr><td bgcolor="#FFFFCC">利用</td><td><input type="radio" name="a_conf" value="1"$checked1>する<input type="radio" name="a_conf" value="0"$checked0>しない</td></tr><tr><td colspan="2">&nbsp;</td></tr>|;
		$sub_message = <<"END";
