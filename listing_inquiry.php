...
<div class="ask_area">
<label for="ask">お問い合わせ内容</label><br /><strong class="remark">リスティング広告メニュー</strong><br /><strong class="remark">（2,500円で10,000円分のアドワーズ広告が掲載できるプロモーションコードプレゼント）</strong><br/><input type="hidden" name="ask" value="リスティング広告メニュー2,500円で10,000円分のアドワーズ広告が掲載できるプロモーションコードプレゼント）" />
